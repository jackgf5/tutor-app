    ...
    <div className="flex w-2/3 h-full items-center justify-center">
      <div className="flex flex-col  h-full justify-center items-center gap-2 w-1/2">
        ...
        {loading && loading2 ? (
          ...
          <div className=" w-[80%] h-[60%] p-10 shadow-xl rounded-xl bg-white  ">
      ...
      <table className="w-full h-1/2 border-collapse bg-white text-left text-sm text-gray-500 overflow-scroll scrollbar-hide">
        ...
        <tbody className="divide-y divide-gray-100 border-t border-gray-100 h-1/2 w-full">
